...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of mangonote birth 2014-04-18 10:49:53 (1397818193)
    var mangonoteBirthTime = _nettype == "Mainnet" ? 1397818193 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    ...
    var secondsPerBlock;
    // before mangonote's birth
    if (requestedTime < mangonoteBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < mangonoteBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > mangonoteBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - mangonoteBirthTime)/secondsPerBlockV1);
