...
ColumnLayout {
    ...
    RowLayout {
        ...
        MangonoteComponents.Label {
            color: lineEdit.inputHasFocus ? MangonoteComponents.Style.defaultFontColor : MangonoteComponents.Style.dimmedFontColor
            fontSize: 13
            text: (wordNumber + 1)
        ...
        MangonoteComponents.TextPlain {
            ...
            color: wordsMatch ? (MangonoteComponents.Style.blackTheme ? "#00FF00" : "#008000") : "#FF0000"
            themeTransition: false
            onTextChanged: {
    ...
    Rectangle {
        id: underLine
        color: lineEdit.inputHasFocus ? MangonoteComponents.Style.defaultFontColor : MangonoteComponents.Style.appWindowBorderColor
